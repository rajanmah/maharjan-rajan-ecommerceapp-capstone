    ...
    return (
        <div className="main">
            <div className="intro">
                ...
                <Link to="/products" style={{ textDecoration: "none" }} className="explore"><span className="explore">explore</span></Link> <br />
                {/* <Link to="/products" style={{ textDecoration: "none" }} ><span>we deliver FREE!</span></Link> */}
